...
const IUINT32 IKCP_CMD_PUSH = 81;		// 0x51 cmd: push data
const IUINT32 IKCP_CMD_ACK  = 82;		// 0x52 cmd: ack
const IUINT32 IKCP_CMD_WASK = 83;		// 0x53 cmd: window probe (ask)
const IUINT32 IKCP_CMD_WINS = 84;		// 0x54 cmd: window size (tell)
