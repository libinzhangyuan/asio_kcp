...
connection::shared_ptr connection_container::add_new_connection(udp::socket& udp_socket, const kcp_conv_t& conv)
{
    connection::shared_ptr ptr = connection::create(udp_socket, conv);
